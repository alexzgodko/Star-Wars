...
4. Class Explosion - покадровая анимация помадания пули в астероид
    1. size - 'lg': при коллизии пули с астероидом, 'sm': при коллизии астероида с кораблем
    2. image - текущее изображение
    3. rect - прямоугольник изображения
    4. rect.center - центр прямоугольника
    5. frame - номер текущего кадра анимации
    6. frame_rate - сколько мс показываем один кадр анимации 
    7. last_update - последнее обновление 
